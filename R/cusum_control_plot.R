...
#'
#'
#' Returns a ggplot2 object showing calculated control limits. This function should be used after calculating the control limits with either \code{\link{cusum_control}} or \code{\link{cusum_control_median}}.
#'
