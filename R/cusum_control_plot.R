...
#' @param above whether to highlight points above the UCL, default is TRUE
#' @param below whether to highlight points below the LCL, default is FALSE
...
# red points for those above ucl if 'above' = TRUE
